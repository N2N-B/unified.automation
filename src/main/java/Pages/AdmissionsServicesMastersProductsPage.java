...
public class AdmissionsServicesMastersProductsPage {
	...
	@FindBy(how = How.XPATH, using = "//p[contains(text(),'Onboarding')]")
	private WebElement elm_onBoarding;

	@FindBy(how = How.XPATH, using = "//p[contains(text(),'Profile Gap Analysis')]")
	...
	public WebElement clickOnBoarding() {
		...
		try {
			fWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//p[contains(text(),'Onboarding')]")));
		} catch (Exception e) {

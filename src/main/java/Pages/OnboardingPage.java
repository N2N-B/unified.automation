...
public class OnboardingPage {
	...
	@FindBy(how = How.XPATH, using = "//span[contains(text(),'Onboarding Complete')]")
	private WebElement elm_onBoarding;

	@FindBy(how = How.XPATH, using = "//p[contains(text(),'Personal Information')]")
	private WebElement elm_personalInformation;

	@FindBy(how = How.XPATH, using = "//p[contains(text(),'Academic Information')]")
	private WebElement elm_academicInformation;

	@FindBy(how = How.XPATH, using = "//p[contains(text(),'Work Experience')]")
	private WebElement elm_workExperience;

	@FindBy(how = How.XPATH, using = "//p[contains(text(),'Aspiration Details')]")
	private WebElement elm_aspirationalDetails;

	@FindBy(how = How.XPATH, using = "//p[contains(text(),'Graduate Admission Test')]")
	private WebElement elm_graduateAdmissionTest;

	@FindBy(how = How.XPATH, using = "//p[contains(text(),'Tests and Survey')]")
	private WebElement elm_testsAndSurvey;

	@FindBy(how = How.XPATH, using = "//p[contains(text(),'Upload CV')]")
